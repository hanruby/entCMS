<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/MasterPage.master" AutoEventWireup="true" CodeBehind="ResList.aspx.cs" Inherits="entCMS.Manage.ResList" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="cphButtons" runat="server">
    <a href="ResAdd.aspx?node=<%=NodeCode %>" class="btn">添加</a>
</asp:Content>
