<%@ Page Title="" Language="C#" MasterPageFile="~/global/Inside.master" AutoEventWireup="true" CodeBehind="NewsShow.aspx.cs" Inherits="entCMS.HengyiLogisticsWeb.global.NewsShow" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="cphSubTitle" runat="server">
    嘉里物流是亚洲领先的物流服务供应商，也是众多财富 500 强企业一致之选。
</asp:Content>
