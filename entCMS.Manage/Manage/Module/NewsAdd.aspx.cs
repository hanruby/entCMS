...
namespace entCMS.Manage.Module
{
    public partial class NewsAdd : BasePage
    {
        ...
        private void InitControls()
        {
            ...
            List<cmsNewsCatalog> catalogs = ncs.GetCatalogs(CurrentLanguageId, 0, 1, 2);
        ...
        protected override void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (action.Equals("add"))
                {
                    ...
                    ScriptUtil.ConfirmAndRedirect(@"文章添加成功！\n“确定”继续添加，“取消”则跳转到列表页。", "NewsAdd.aspx?node=" + NodeCode, "NewsList.aspx?node=" + NodeCode);
                }
                else
                {
                    ScriptUtil.ConfirmAndRedirect(@"文章修改成功！\n“确定”留在本页，“取消”则跳转到列表页。", "NewsAdd.aspx?node=" + NodeCode + "&id=" + id + "&action=edit", "NewsList.aspx?node=" + NodeCode);
                }
