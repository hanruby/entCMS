...
namespace entCMS.Models
{
	...
	/// <summary>
	/// 实体类cmsLinkGroup 。(属性说明自动提取数据库字段的描述信息)
	/// </summary>
	[Serializable]
	public class cmsLinkGroup : Entity 
	{
		public cmsLinkGroup():base("cmsLinkGroup") {}
		...
		public class _
		{
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*","cmsLinkGroup");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field Id = new Field("Id","cmsLinkGroup","Id");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field Name = new Field("Name","cmsLinkGroup","Name");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field OrderNo = new Field("OrderNo","cmsLinkGroup","OrderNo");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field IsEnabled = new Field("IsEnabled","cmsLinkGroup","IsEnabled");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field LangId = new Field("LangId","cmsLinkGroup","LangId");
		}
		#endregion
