<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/MasterPage.master" AutoEventWireup="true" ValidateRequest="false" CodeBehind="CompanyAdd.aspx.cs" Inherits="entCMS.Manage.CompanyAdd" %>
    ...
    <table border="0" align="center" cellpadding="0" cellspacing="0" class="detail">
        ...
        <tr>
            ...
            <td>
                ...
                <a href='CompanyList.aspx?node=<%=NodeCode %>' class="btn">列表</a>
            </td>
        </tr>
    </table>
</asp:Content>
