<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/MasterPage.master" ValidateRequest="false" AutoEventWireup="true" CodeBehind="NewsAdd.aspx.cs" Inherits="entCMS.Manage.Module.NewsAdd" %>
    ...
    <table border="0" align="center" cellpadding="0" cellspacing="0" class="detail">
        <tr>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator ID="rfvCatalog" runat="server" ControlToValidate="ddlCatalog" ErrorMessage="请选择文章栏目" Display="None"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td class="col">
            ...
            <td>
                ...
                <br />
                <asp:RequiredFieldValidator ID="rfvTitle" runat="server" ControlToValidate="txtTitle" ErrorMessage="请输入文章标题" SetFocusOnError="true" Display="None"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td class="col">
        ...
        <tr>
            ...
            <td>
                ...
                <a href="NewsList.aspx?node=<%=NodeCode %>" class="btn">取消</a>
            </td>
        </tr>
    </table>
</asp:Content>
