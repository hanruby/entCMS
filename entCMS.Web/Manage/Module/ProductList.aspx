<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/MasterPage.master" AutoEventWireup="true" CodeBehind="ProductList.aspx.cs" Inherits="entCMS.Manage.Module.ProductList" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="cphButtons" runat="server">
    <a href="ProductAdd.aspx?node=<%=NodeCode %>" class="btn">添加</a>
...
<asp:Content ID="Content5" ContentPlaceHolderID="cphMain" runat="server">
    <fieldset>
        <legend>查询框</legend>
        <div class="field">
            <label>产品名称</label><span><asp:TextBox ID="txtTitle" runat="server"></asp:TextBox></span>
            <label>产品编号</label><span><asp:TextBox ID="txtProductNo" runat="server"></asp:TextBox></span>
            <label>产品型号</label><span><asp:TextBox ID="txtModel" runat="server"></asp:TextBox></span>
    ...
    <asp:GridView ID="gv" runat="server" CssClass="SmartGridView" AutoGenerateColumns="False" Width="100%" 
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="产品名称" ItemStyle-HorizontalAlign="Left">
                <ItemTemplate>
                    <%#GetTitle(Container.DataItem) %>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:BoundField HeaderText="产品编号" DataField="ProductNo" HeaderStyle-Width="100" />
            <asp:BoundField HeaderText="产品型号" DataField="ProductModel" HeaderStyle-Width="100" />
            ...
            <asp:TemplateField HeaderText="操作" HeaderStyle-Width="100">
                <ItemTemplate>
                    <a href='ProductAdd.aspx?node=<%#Eval("NodeCode") %>&id=<%#Eval("Id") %>&action=edit'>编辑</a>
...
<asp:Content ID="Content6" ContentPlaceHolderID="cphOther" runat="server">
    <script type="text/javascript">
        ...
        function copyto() {
            ...
            top.Dialog.open({ Title: '复制到...', Width: 700, Height: 500, URL: 'Module/NewsCopyTo.aspx?node=<%=NodeCode %>&type=0|4&id=' + id });
            return false;
        }
        ...
        function moveto() {
            ...
            if (id.length > 0) id = id.substring(1);
            top.Dialog.open({ Title: '移动到...', Width: 700, Height: 500, URL: 'Module/NewsMoveTo.aspx?node=<%=NodeCode %>&type=0|4&id=' + id });
            return false;
        }
    </script>
</asp:Content>
