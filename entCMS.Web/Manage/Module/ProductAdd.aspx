<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/MasterPage.master" AutoEventWireup="true" ValidateRequest="false" CodeBehind="ProductAdd.aspx.cs" Inherits="entCMS.Manage.Module.ProductAdd" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="cphMain" runat="server">
    ...
    <table border="0" align="center" cellpadding="0" cellspacing="0" class="detail">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtTitle" CssClass="input" runat="server" Width="350"></asp:TextBox>
                <br />
                <asp:RequiredFieldValidator ID="rfvTitle" runat="server" ControlToValidate="txtTitle" ErrorMessage="请输入产品名称" SetFocusOnError="true" Display="None"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td class="col">
            ...
            <td>
                <asp:TextBox ID="txtProductNo" CssClass="input" runat="server" Width="350" MaxLength="100"></asp:TextBox>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtModel" CssClass="input" runat="server" Width="350" MaxLength="100"></asp:TextBox>
                <span class="tips">100个字符以内</span>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="col"></td>
            <td><a href="javascript:void(0)" onclick="$('.para').fadeToggle('fast');"><b>显示更多参数</b></a></td>
        </tr>
        <tr class="para" style="display:none">
            <td class="col">
                产品参数一：
            </td>
            <td>
                <asp:TextBox ID="txtParameter1" CssClass="input" runat="server" Width="350" MaxLength="100"></asp:TextBox>
                <span class="tips">100个字符以内</span>
            </td>
        </tr>
        <tr class="para" style="display:none">
            ...
            <td>
                <asp:TextBox ID="txtParameter2" CssClass="input" runat="server" Width="350" MaxLength="100"></asp:TextBox>
                <span class="tips">100个字符以内</span>
            </td>
        </tr>
        <tr class="para" style="display:none">
            ...
            <td>
                <asp:TextBox ID="txtParameter3" CssClass="input" runat="server" Width="350" MaxLength="100"></asp:TextBox>
                <span class="tips">100个字符以内</span>
            </td>
        </tr>
        <tr class="para" style="display:none">
            ...
            <td>
                <asp:TextBox ID="txtParameter4" CssClass="input" runat="server" Width="350" MaxLength="100"></asp:TextBox>
                <span class="tips">100个字符以内</span>
            </td>
        </tr>
        <tr class="para" style="display:none">
            ...
            <td>
                <asp:TextBox ID="txtParameter5" CssClass="input" runat="server" Width="350" MaxLength="100"></asp:TextBox>
                <span class="tips">100个字符以内</span>
            </td>
        </tr>
        <tr class="para" style="display:none">
            ...
            <td>
                <asp:TextBox ID="txtParameter6" CssClass="input" runat="server" Width="350" MaxLength="100"></asp:TextBox>
                <span class="tips">100个字符以内</span>
            </td>
        </tr>
        <tr class="para" style="display:none">
            ...
            <td>
                <asp:TextBox ID="txtParameter7" CssClass="input" runat="server" Width="350" MaxLength="100"></asp:TextBox>
                <span class="tips">100个字符以内</span>
            </td>
        </tr>
        <tr class="para" style="display:none">
            ...
            <td>
                <asp:TextBox ID="txtParameter8" CssClass="input" runat="server" Width="350" MaxLength="100"></asp:TextBox>
                <span class="tips">100个字符以内</span>
            </td>
        </tr>
        <tr class="para" style="display:none">
            ...
            <td>
                <asp:TextBox ID="txtParameter9" CssClass="input" runat="server" Width="350" MaxLength="100"></asp:TextBox>
                <span class="tips">100个字符以内</span>
            </td>
        </tr>
        <tr class="para" style="display:none">
            <td class="col">其他相关图</td>
            <td valign="middle">
                <asp:HiddenField ID="hidImages2" runat="server" />
                <span id="spanButtonPlaceholder2"></span><span class="tips">(最大 2.0MB)</span><button onclick="clearImages(2);return false;">清空</button>
        ...
        <tr>
            ...
            <td>
                ...
                <a href="ProductList.aspx?node=<%=NodeCode %>" class="btn">取消</a>
            </td>
        </tr>
    </table>
</asp:Content>
...
<script type="text/javascript">
    ...
    function addImage(id, imgfile) {
        if (id == 1) {
            ...
            var val = $('#<%=hidImages2.ClientID %>').val();
            $('#<%=hidImages2.ClientID %>').val(val + "|" + imgfile);
        }
        ...
        var btn = $("<div class='cancel' title='点击删除图片'></div>").appendTo(div).click(function () {
            ...
            if (id == 1) {
                ...
                var v = $('#<%=hidImages2.ClientID %>').val();
                v = v.replace("|" + imgfile, "");
                $('#<%=hidImages2.ClientID %>').val(v);
            }
    ...
    $(function () {
        ...
        var settings_object2 = {
            ...
            file_upload_limit: 100,
            file_queue_limit: 0,
            button_action: SWFUpload.BUTTON_ACTION.SELECT_FILES, // 一次选择多个文件
            button_window_mode: 'transparent',
